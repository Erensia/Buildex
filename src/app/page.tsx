      ...
      <main className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-[1.3fr_0.7fr] lg:py-36">
        <section>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link className="rounded-xl bg-violet-500 px-5 py-3 font-bold text-white transition hover:bg-violet-400" href="/signup">빌드 만들기</Link>
            <span className="rounded-xl border border-zinc-700 px-5 py-3 text-zinc-300">장리 · 루파 · 브랜트 준비 중</span>
          </div>
        </section>
