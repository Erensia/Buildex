    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <nav className="flex items-center gap-5 text-sm text-zinc-400">
          <Link href="/characters" className="hover:text-white">공개 정보</Link>
      ...
      <main className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-[1.3fr_0.7fr] lg:py-36">
        <section>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link className="rounded-xl bg-violet-500 px-5 py-3 font-bold text-white transition hover:bg-violet-400" href="/characters">정보 둘러보기</Link>
