...
const subStatKeys = ["flatAttack", "attackPercent", "flatHealth", "healthPercent", "flatDefense", "defensePercent", "critRate", "critDamage", "energyRegen", "basicAttackDamageBonus", "heavyAttackDamageBonus", "resonanceSkillDamageBonus", "resonanceLiberationDamageBonus"] as const;
